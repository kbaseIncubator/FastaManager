...
function FastaManager(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.build_fasta = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "FastaManager.build_fasta",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "FastaManager.status",
